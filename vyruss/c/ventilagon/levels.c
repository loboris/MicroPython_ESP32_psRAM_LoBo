...
const Level level1 = {50000L, 4, 5, '1', 0x0000ff, 0x000000, 0x000001, patterns_level1, elements_in(patterns_level1), &no_drift};
const Level level2 = {45000L, 4, 6, '2', 0x00ff00, 0x000000, 0x000100, patterns_level2, elements_in(patterns_level2), &slow_drift};
const Level level3 = {40000L, 4, 7, '3', 0xffff00, 0x000000, 0x010100, patterns_level3, elements_in(patterns_level3), &slow_drift};
const Level level4 = {40000L, 4, 7, '1', 0x00ffff, 0x000000, 0x000101, patterns_level4, elements_in(patterns_level4), &med_drift};
const Level level5 = {40000L, 4, 7, '2', 0xff00ff, 0x000000, 0x010001, patterns_level5, elements_in(patterns_level5), &high_drift};
const Level level6 = {40000L, 4, 7, '3', 0xff0000, 0x000000, 0x010000, patterns_level6, elements_in(patterns_level6), &crazy_drift};
